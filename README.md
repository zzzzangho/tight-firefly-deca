...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/tight-firefly-deca)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/tight-firefly-deca#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tight-firefly-deca
```

A live public deployment of this template is available at [https://tight-firefly-deca.templates.workers.dev](https://tight-firefly-deca.templates.workers.dev)
